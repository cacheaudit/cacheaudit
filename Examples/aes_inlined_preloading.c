...
/* aes_light. Same as aes_inlined.c, but with key schedule is removed.
In fact, it corresponds to original aes.c, because precisely the key schedule has been inlined
*/
