...
module DS = struct
  ...
  module SetState = Set.Make(struct type t = int NumMap.t let compare = (NumMap.compare compare) end)
  module SetSetState = Set.Make(struct type t = SetState.t let compare = (SetState.compare) end)			      
